...
<Callout emoji="֍">Use a mask to generate images</Callout>
...
<div className="grid grid-cols-1 mt-4 w-full">
  <Card>
    <CardContent className="flex justify-center pt-1 pb-0">
      <Image
        src="https://media.substrate.run/logo-sq.png"
        width={300}
        height={300}
        alt="original"
      />
...
<div className="grid grid-cols-1 lg:grid-cols-2 mt-4 w-full">
  <Card>
    <CardContent className="flex justify-center pt-1 pb-0">
      <Image
        src="https://media.substrate.run/illusion-1.jpg"
        width={300}
        height={300}
        alt="image"
      />
  ...
  <Card>
    <CardContent className="flex justify-center pt-1 pb-0">
      <Image
        src="https://media.substrate.run/illusion-2.jpg"
        width={300}
        height={300}
        alt="no background"
      />
...
<div className="grid grid-cols-1 lg:grid-cols-2 mt-4 w-full">
  <Card>
    <CardContent className="flex justify-center pt-1 pb-0">
      <Image
        src="https://media.substrate.run/logo-atlantis-1.jpg"
        width={300}
        height={300}
        alt="image"
      />
  ...
  <Card>
    <CardContent className="flex justify-center pt-1 pb-0">
      <Image
        src="https://media.substrate.run/logo-atlantis-2.jpg"
        width={300}
        height={300}
        alt="no background"
      />
...
<div className="grid grid-cols-1 lg:grid-cols-2 mt-4 w-full">
  <Card>
    <CardContent className="flex justify-center pt-1 pb-0">
      <Image
        src="https://media.substrate.run/ex-controlnet.jpeg"
        width={300}
        height={300}
        alt="image"
      />
  ...
  <Card>
    <CardContent className="flex justify-center pt-1 pb-0">
      <Image
        src="https://media.substrate.run/ex-cn-inpaint.webp"
        width={300}
        height={300}
        alt="no background"
      />
