...
<Callout emoji="֍">
  Generate variations of a room in different styles and summarize the interior
  design
</Callout>
...
- Use <StableDiffusionXLControlNet /> with the _`edge`_ method to generate variations structured by the edges of the original image.
- Use <StableDiffusionXLControlNet /> with the _`depth`_ method to generate variations structured by a depth map of the original image.
...
<div className="grid grid-cols-1 mt-4 w-full">
  <Card>
    <CardContent className="flex justify-center pt-1 pb-0">
      <Image
        src="https://media.substrate.run/office.jpg"
        width={600}
        height={450}
        alt="original"
      />
...
<div className="grid grid-cols-1 lg:grid-cols-2 mt-4 w-full">
  <Card>
    <CardContent className="flex justify-center pt-1">
      <Image
        src="https://media.substrate.run/inpaint-tokyo.jpg"
        width={600}
        height={450}
        alt="inpaint tokyo"
      />
  ...
  <Card>
    <CardContent className="flex justify-center pt-1">
      <Image
        src="https://media.substrate.run/inpaint-berlin.jpg"
        width={600}
        height={450}
        alt="inpaint berlin"
      />
...
<Callout emoji="֍">
  <InpaintImage /> is a high-level alternative to
  `StableDiffusionXLControlNet`. You should use high-level nodes if you want
  your node to automatically update to the latest, best model.
</Callout>

Next, we'll generate variations using <StableDiffusionXLControlNet /> with the _`edge`_ method, which processes the original image with an edge detection algorithm and uses edges to structure generation.
...
<div className="grid grid-cols-1 lg:grid-cols-2 mt-4 w-full">
  <Card>
    <CardContent className="flex justify-center pt-1">
      <Image
        src="https://media.substrate.run/edge-tokyo.jpg"
        width={600}
        height={450}
        alt="edge tokyo"
      />
  ...
  <Card>
    <CardContent className="flex justify-center pt-1">
      <Image
        src="https://media.substrate.run/edge-berlin.jpg"
        width={600}
        height={450}
        alt="edge berlin"
      />
...
Finally, we'll use <StableDiffusionXLControlNet /> with the _`depth`_ method, which processes the original image with a depth detection algorithm and uses depth to structure generation. We'll continue our workflow to describe the generated variations using <ComputeText />, and then summarize the generated descriptions using <ComputeText />.
...
<div className="grid grid-cols-1 lg:grid-cols-2 mt-4 w-full">
  <Card>
    <CardContent className="flex justify-center pt-1">
      <Image
        src="https://media.substrate.run/depth-tokyo.jpg"
        width={600}
        height={450}
        alt="edge tokyo"
      />
    ...
    <CardFooter className="w-full flex justify-center">
      The living room boasts a spacious design with a large window allowing
      natural light and a cozy couch. Unique is the open-concept office area,
      separated by a partial wall, offering a functional workspace while
      maintaining unity, enhanced by plants, lamps, and a rug in the modern,
      minimalist decor.
    </CardFooter>
  </Card>
  <Card>
    <CardContent className="flex justify-center pt-1">
      <Image
        src="https://media.substrate.run/depth-berlin.jpg"
        width={600}
        height={450}
        alt="edge berlin"
      />
    ...
    <CardFooter className="w-full flex justify-center">
      The image features a contemporary office with a captivating pink and
      purple color scheme: vibrant pink walls instill energy, while elegant
      purple furniture adds sophistication.
    </CardFooter>
  </Card>
</div>
