...
Substrate supports connecting to external providers like OpenAI and Anthropic. To use external providers, provide `secrets` when initializing the _`Substrate`_ client:
